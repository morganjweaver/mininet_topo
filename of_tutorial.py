...
class Tutorial (object):
  ...
  def act_like_switch (self, packet, packet_in, eventPort):
    """
    ...
    #self.mac_to_port[str(packet.src)] = packet_in.port
    ...
    if str(packet.dst) in self.mac_to_port:
      ...
      msg.match = of.ofp_match.from_packet(packet, eventPort)
      #
      #< Set other fields of flow_mod (timeouts? buffer_id?) >
      #
      #< Add an output action, and send -- similar to resend_packet() >
      msg.idle_timeout = 10 #duration[0]
      msg.hard_timeout = 30 #duration[1]
  ...
  def _handle_PacketIn (self, event):
    ...
    self.act_like_switch(packet, packet_in, eventPort)

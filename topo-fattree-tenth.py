...
class MyTopo( Topo ):
	...
	#for k in range(0,5):
    self.addLink( self.CoreSwitches[0], self.AggregateSwitches[0], **linkopts )
    self.addLink( self.CoreSwitches[0], self.AggregateSwitches[1], **linkopts )
	...
	#for k in range(0,10):
	    #if(k % 2 == 0):
    self.addLink( self.AggregateSwitches[0], self.AccessSwitches[0], **linkopts )
    self.addLink( self.AggregateSwitches[0], self.AccessSwitches[1], **linkopts )
	    #else:
    self.addLink( self.AggregateSwitches[1], self.AccessSwitches[0], **linkopts )
    self.addLink( self.AggregateSwitches[1], self.AccessSwitches[1], **linkopts )
    ...
    self.addLink( self.AccessSwitches[1], self.Hosts[0], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[1], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[2], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[3], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[4], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[5], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[6], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[7], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[8], **linkopts )
    self.addLink( self.AccessSwitches[1], self.Hosts[9], **linkopts )
